...
namespace eShop.Identity.Module.Controllers;
...
public class SecurityHeadersAttribute : ActionFilterAttribute
{
    public override void OnResultExecuting(ResultExecutingContext context)
    {
        ...
        if (result is ViewResult)
        {
            ...
            var csp = "default-src 'self' https://cdn.jsdelivr.net/; object-src 'none'; frame-ancestors 'none'; sandbox allow-forms allow-same-origin allow-scripts; base-uri 'self';";
