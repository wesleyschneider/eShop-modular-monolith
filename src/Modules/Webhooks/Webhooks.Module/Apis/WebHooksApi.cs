...
using eShop.Webhooks.Module.Extensions;

namespace eShop.Webhooks.Module;

public static class WebHooksApi
{
    public static IEndpointRouteBuilder MapWebHooksApi(this IEndpointRouteBuilder app)
    {
        app.MapWebHooksApiV1();
        return app;
    }
