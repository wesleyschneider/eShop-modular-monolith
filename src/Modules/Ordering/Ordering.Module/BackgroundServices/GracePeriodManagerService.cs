...
namespace eShop.Ordering.Module.BackgroundServices;
    ...
    NpgsqlDataSource dataSource) : BackgroundService
{
    ...
    {
        int time = _options.CheckUpdateTime == 0 ? 20 : _options.CheckUpdateTime;
        var delayTime = TimeSpan.FromSeconds(time);
